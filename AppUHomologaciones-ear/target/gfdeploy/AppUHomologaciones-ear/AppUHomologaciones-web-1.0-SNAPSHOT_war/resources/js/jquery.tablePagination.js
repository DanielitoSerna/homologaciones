 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="/Mediador-web/resources/images/prev_two.png",  
			prevArrow : (new Image()).src="/Mediador-web/resources/images/prev_one.png",
			lastArrow : (new Image()).src="/Mediador-web/resources/images/next_two_d.png",
			nextArrow : (new Image()).src="/Mediador-web/resources/images/next_one_d.png",
			rowsPerPage : 5,
			currPage : 1,
      ...
      var tableRows = document.getElementById("formu:tablaLista").tBodies.item(0).rows;
